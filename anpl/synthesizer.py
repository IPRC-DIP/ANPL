...
def fun_synthesis(anpl: ANPL, name: str, temp:float = 0) -> Optional[str]:
    ...
    res = query(msgs, model="gpt-3.5-turbo-0301", max_tokens=2048, temperature=temp)[0]
    return res
...
def batch_fun_synthesis(anpl: ANPL, name: str, n:int, temp:float) -> list[Optional[str]]:
    ...
    reses = query(msgs, model="gpt-3.5-turbo-0301", max_tokens=2048, n=n, temperature=temp)
